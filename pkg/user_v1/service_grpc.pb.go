...
func (c *userV1Client) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedUserV1Server) Create(context.Context, *CreateRequest) (*emptypb.Empty, error) {
