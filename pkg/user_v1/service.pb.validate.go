...
func (m *User) validate(all bool) error {
	...
	if strings.Contains(m.GetUsername(), " ") {
		err := UserValidationError{
			field:  "Username",
	...
	if strings.Contains(m.GetPassword(), " ") {
		err := UserValidationError{
			field:  "Password",
			reason: "value contains substring \" \"",
		}
...
// Validate checks the field values on UserNullable with the rules defined in
...
// ValidateAll checks the field values on UserNullable with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UserNullableMultiError, or
// nil if none found.
func (m *UserNullable) ValidateAll() error {
	return m.validate(true)
}

func (m *UserNullable) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if wrapper := m.GetUsername(); wrapper != nil {
		...
		if utf8.RuneCountInString(wrapper.GetValue()) < 4 {
			err := UserNullableValidationError{
				field:  "Username",
				reason: "value length must be at least 4 runes",
			}
			if !all {
		...
		if strings.Contains(wrapper.GetValue(), " ") {
			err := UserNullableValidationError{
				field:  "Username",
				reason: "value contains substring \" \"",
			}
	...
	if len(errors) > 0 {
		return UserNullableMultiError(errors)
	}

	return nil
}

func (m *UserNullable) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *UserNullable) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
...
// UserNullableMultiError is an error wrapping multiple validation errors
// returned by UserNullable.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m UserNullableMultiError) AllErrors() []error { return m }

// UserNullableValidationError is the validation error returned by
// UserNullable.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e UserNullableValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserNullableValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserNullableValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserNullableValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserNullableValidationError) ErrorName() string { return "UserNullableValidationError" }

// Error satisfies the builtin error interface
func (e UserNullableValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UserNullableValidationError{}
...
func (m *CreateRequest) validate(all bool) error {
	...
	if strings.Contains(m.GetPasswordConfirm(), " ") {
		err := CreateRequestValidationError{
			field:  "PasswordConfirm",
			reason: "value contains substring \" \"",
		}
